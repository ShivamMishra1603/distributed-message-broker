...
const (
	AdminService_CreateTopic_FullMethodName   = "/broker.v1.AdminService/CreateTopic"
	AdminService_ListTopics_FullMethodName    = "/broker.v1.AdminService/ListTopics"
	AdminService_DescribeTopic_FullMethodName = "/broker.v1.AdminService/DescribeTopic"
)
...
var AdminService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "broker.v1.AdminService",
...
const (
	BrokerService_Produce_FullMethodName              = "/broker.v1.BrokerService/Produce"
	BrokerService_Fetch_FullMethodName                = "/broker.v1.BrokerService/Fetch"
	BrokerService_CommitOffset_FullMethodName         = "/broker.v1.BrokerService/CommitOffset"
	BrokerService_FetchCommittedOffset_FullMethodName = "/broker.v1.BrokerService/FetchCommittedOffset"
)
...
func (c *brokerServiceClient) FetchCommittedOffset(ctx context.Context, in *FetchCommittedOffsetRequest, opts ...grpc.CallOption) (*FetchCommittedOffsetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FetchCommittedOffsetResponse)
	err := c.cc.Invoke(ctx, BrokerService_FetchCommittedOffset_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBrokerServiceServer) FetchCommittedOffset(context.Context, *FetchCommittedOffsetRequest) (*FetchCommittedOffsetResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method FetchCommittedOffset not implemented")
}
...
func _BrokerService_FetchCommittedOffset_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FetchCommittedOffsetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServiceServer).FetchCommittedOffset(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BrokerService_FetchCommittedOffset_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServiceServer).FetchCommittedOffset(ctx, req.(*FetchCommittedOffsetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BrokerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BrokerService_FetchCommittedOffset_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "broker/v1/broker.proto",
